...
// @Success 200 {object} types.CreateUsersRespond{}
...
// @Success 200 {object} types.DeleteUsersByIDRespond{}
...
// @Accept json
// @Produce json
// @Success 200 {object} types.DeleteUserssByIDsRespond{}
...
// @Success 200 {object} types.UpdateUsersByIDRespond{}
...
// @Accept json
// @Produce json
// @Success 200 {object} types.GetUsersByIDRespond{}
// @Router /api/v1/users/{id} [get]
// @Security BearerAuth
func (h *usersHandler) GetByID(c *gin.Context) {
	idStr, id, isAbort := getUsersIDFromPath(c)
	if isAbort {
		response.Error(c, ecode.InvalidParams)
		return
	}
...
// @Accept json
// @Produce json
// @Success 200 {object} types.GetUsersByConditionRespond{}
...
func (h *usersHandler) GetByCondition(c *gin.Context) {
	...
	data.ID = utils.Uint64ToStr(users.ID)
...
// @Accept json
// @Produce json
// @Success 200 {object} types.ListUserssByIDsRespond{}
...
// @Success 200 {object} types.ListUserssRespond{}
