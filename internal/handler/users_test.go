...
func Test_usersHandler_DeleteByIDs(t *testing.T) {
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteUserssByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = gohttp.Post(result, h.GetRequestURL("DeleteByIDs"), &types.DeleteUserssByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}
...
func Test_usersHandler_GetByCondition(t *testing.T) {
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("GetByCondition"), &types.GetUsersByConditionRequest{
		query.Conditions{
...
func Test_usersHandler_ListByIDs(t *testing.T) {
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("ListByIDs"), &types.ListUserssByIDsRequest{IDs: []uint64{testData.ID}})
	if err != nil {
		t.Fatal(err)
	}
	if result.Code != 0 {
	...
	// get error test
	err = gohttp.Post(result, h.GetRequestURL("ListByIDs"), &types.ListUserssByIDsRequest{IDs: []uint64{111}})
	assert.Error(t, err)
}
...
func Test_usersHandler_List(t *testing.T) {
	...
	result := &gohttp.StdResult{}
	err := gohttp.Post(result, h.GetRequestURL("List"), &types.ListUserssRequest{query.Params{
		Page: 0,
		Size: 10,
